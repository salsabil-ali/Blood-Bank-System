...
-- =========================
-- BLOOD UNIT (مع Status)
-- =========================
INSERT INTO Blood_Unit VALUES
(1001,'A+','2026-04-01','2026-06-01','Used',101),
(1002,'O+','2026-04-03','2026-06-03','Used',102),
(1003,'B+','2026-04-05','2026-06-05','Used',103),
(1004,'AB+','2026-04-07','2026-06-07','Used',104),
(1005,'O-','2026-04-10','2026-06-10','Used',105),
(1006,'A-','2026-04-11','2026-06-11','Available',106),
(1007,'O-','2026-04-12','2026-06-12','Used',107),
(1008,'AB-','2026-04-13','2026-06-13','Used',108),
(1009,'B-','2026-04-17','2026-06-17','Used',109),
(1010,'A+','2026-04-18','2026-06-18','Available',110),
(1011,'O+','2026-04-19','2026-06-19','Used',111),
(1012,'AB+','2026-04-20','2026-06-20','Available',112),
(1013,'A+','2026-04-21','2026-06-21','Used',113),
(1014,'O-','2026-04-21','2026-06-21','Available',114);
...
(302,'2026-04-13','O+',1,'Completed',202),
(303,'2026-04-14','B+',1,'Completed',203),
(304,'2026-04-15','O-',2,'Completed',204),
(305,'2026-04-16','AB-',1,'Completed',205),
(306,'2026-04-18','A+',2,'Pending',206),
(307,'2026-04-19','O+',2,'Pending',207),
(308,'2026-04-20','B-',1,'Approved',206);
...
BEGIN
    ...
    VALUES (@Request_ID,@Request_Date,@Blood_Type,@Quantity_Requested,'Pending',@Hospital_ID)
END;
GO
...
CREATE FUNCTION CountAvailableUnits(@BloodType VARCHAR(5))
RETURNS INT
AS
BEGIN
    DECLARE @Total INT
